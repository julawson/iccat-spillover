...
iccat_df_short <- read.csv(here("data", "iccat_df_edited.csv"),
                      stringsAsFactors = F)
...
iccat_df_controls <- bind_rows(iccat_df_1982,iccat_df_1997, iccat_df_1998, iccat_df_1999,iccat_df_2001,iccat_df_2005, iccat_df_2006,iccat_df_2013,iccat_df_2017,iccat_df_2019)
...
iccat_treatedunits <- read.csv(here("data", "iccat_df_edited.csv"),
                               stringsAsFactors = F)

iccat_treatedunits <- iccat_df_short %>% 
  filter(tacever=="1") %>% 
  select(scaled_tacr, yearTACimp, SpeciesStock, propStock) %>% 
...
iccat_treatedunits<-iccat_treatedunits %>% 
  ...
  select(scaled_tacr, av_propStock, SpeciesStock) %>% 
...
ggplot() +
  ...
  scale_colour_manual(values=c("#696969","#696969","#696969","#696969","#696969", "#696969", "#696969", "#696969", "#696969", "#696969", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c","#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c", "#e31a1c")) +
...
#       filename = here("visuals", "av_propStock_purseseine.png"),
#       width = 5,
 #      height = 3)
